...
public class Hoadon_GUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(12, 12, 12)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtngayhd, javax.swing.GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE)
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã hóa đơn", "Mã khách hàng", "Mã nhân viên", "Ngày hóa đơn", "Tổng tiền"
            }
        ) {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        try {
            ...
            if(hdBUS.check(MaHD))
            {
                JOptionPane.showMessageDialog(null, "Mã hdách hàng đã tồn tại !!!");
                return;
            }
            else
            {
                JOptionPane.showMessageDialog(null, "Thêm hdách hàng thành công.");
            }
            Hoadon_DTO hdDTO= new Hoadon_DTO(MaHD,MaKH,MaNV,NgayHD,tongtien);
            hdBUS.addHD(hdDTO);
            cleanView();
        }
        catch(NumberFormatException ex)
        {
            JOptionPane.showMessageDialog(null,"Chưa nhập đầy đủ thông tin hdách hàng !!!");
        }
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "Vui lòng chọn hdách hàng cần sửa !!!");
            return;
        }
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        hdBUS.getDSHoadon();
        int manv = JOptionPane.showConfirmDialog(null,"Xác nhận xóa hdách hàng!","Xóa hdách hàng", JOptionPane.YES_NO_OPTION);
        if(manv == 0) {
            hdBUS.deleteHD(txtmaHD.getText());
        }
        cleanView();
    ...
    private void btnImportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImportActionPerformed
        ...
        hdBUS.getList();
        int i=0;
        for(Hoadon_DTO hdDTO : hdBUS.dshd) {
            model.addRow(new Object[] {++i,hdDTO.getMaHD(),
                hdDTO.getMaKH(),
                hdDTO.getMaNV(),
                hdDTO.getNgayHD(),
                hdDTO.getTongtien()});
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        if (i>=0){
            ...
            txtmaNV.setText(model.getValueAt(i, 3).toString());
            txtngayhd.setText(model.getValueAt(i, 4).toString());
